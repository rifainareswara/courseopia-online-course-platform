    ...
    <ThemeProvider defaultTheme="dark" storageKey="vite-ui-theme">
      ...
      <Routes>
        ...
        <Route
          path="login"
          element={
            <AuthLayout title={"Masuk ke Courseopia"}>
              <SignIn
                forgotPasswordText="Lupa Kata Sandi Anda?"
                signUpText="Belum punya akun? DAFTAR SEKARANG"
              />
            </AuthLayout>
          }
        />
        <Route
          ...
          element={
            <AuthLayout title={"DAFTAR"}>
              <SignUp signInText={"Apakah Anda punya akun? MASUK"} />
            </AuthLayout>
          }
        />
        <Route
          ...
          element={
            <AuthLayout>
              <ResetPasswordForm signInText={"Apakah Anda punya akun? MASUK"} />
            </AuthLayout>
          }
        />
        <Route
          ...
          element={
            <AuthLayout>
              <ResetPasswordForm
                type="reset-password"
                signInText={"Apakah Anda punya akun? MASUK"}
              />
            </AuthLayout>
          }
        />
